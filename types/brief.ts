 ...
 *
 * Pour enfant : on stocke uniquement le chiffre (ex. "8") pour matcher exactement
 * le catalogue (`tailles_disponibles: ["8", "10", ...]`). Le formulaire ajoute le
 * suffixe " ans" à l'affichage uniquement.
 */
export const BRIEF_TAILLES_HAUT: Record<BriefGenre, readonly string[]> = {
  femme: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
  homme: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
  enfant: ['2', '4', '6', '8', '10', '12', '14', '16'],
};

/** Tailles disponibles pour le bas, par genre (cf. note BRIEF_TAILLES_HAUT). */
